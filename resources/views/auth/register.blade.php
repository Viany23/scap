            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
						...
						<div class="form-group row">
                            <label for="ape1" class="col-md-4 col-form-label text-md-right">{{ __('Primer Apellido') }}</label>
						...
						<div class="form-group row">
                            <label for="ape2" class="col-md-4 col-form-label text-md-right">{{ __('Segundo Apellido') }}</label>

                            <div class="col-md-6">
                                <input id="ape2" type="text" class="form-control @error('ape2') is-invalid @enderror" name="ape2" value="{{ old('ape2') }}" autocomplete="ape2" autofocus>
